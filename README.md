...
![Coroutine async C++ library](https://github.com/rostislav-nikitin/coasyncpp/blob/main/icon-50x50-animated.gif?raw=true)<strong style="font-size: 200%; margin-left: -20px; vertical-align:baseline;">coasyncpp</strong>
